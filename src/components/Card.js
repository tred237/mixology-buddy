    ...
    return(
        <Card>
            ...
            <Card.Body>
                ...
                <Button variant='dark' onClick={() => history.push(`/details/${cocktail.id}`)}>Details</Button> <Button variant='dark' onClick={() => onCocktailDelete(cocktail)} value="Delete">Delete</Button>
            </Card.Body>
        </Card>
    )
}
